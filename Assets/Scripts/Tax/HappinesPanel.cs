...
public class HappinesPanel : MonoBehaviour
{
    ...
    void ChangeHappinesImage(float percentage, float limit)
    {
        ...
        //if (result >= limit)
        //{
        //    // Kýzgýn ifade göstermek için hesaplama
        //    a = (50 - limit) / (spriteCount / 2);  // Üst limit 50 kabul edildi
        //    index = (int)((result - limit) / a) + (spriteCount / 2);

        //    // Eðer index sprite sýnýrýný aþarsa, max kýzgýn ifade ile sýnýrlýyoruz.
        ...
        //    // index eksiye düþerse, minimum mutlu ifade ile sýnýrlýyoruz.
        //    if (index < 0)
        //        index = 0;
        //}
        if(result>0)
